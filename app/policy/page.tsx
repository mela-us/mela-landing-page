      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold bg-gradient-to-r from-[#002060] to-blue-600 bg-clip-text text-transparent mb-4">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
            ...
            <div className="text-gray-700">
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">1. Định nghĩa</h3>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">2. Thông tin chúng tôi thu thập</h3>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">3. Cách chúng tôi sử dụng thông tin</h3>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">4. Bảo mật dữ liệu</h3>
              <p>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">5. Chia sẻ thông tin</h3>
              <p>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">6. Quyền của bạn</h3>
              <p>Bạn có quyền:</p>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">7. Thay đổi chính sách</h3>
              <p>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">8. Liên hệ</h3>
              <p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
            ...
            <div className="text-gray-700">
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">1. Giấy phép sử dụng</h3>
              <p>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">2. Nội dung người dùng</h3>
              <p>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">3. Tài khoản người dùng</h3>
              <p>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">4. Quyền sở hữu trí tuệ</h3>
              <p>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">5. Từ chối trách nhiệm</h3>
              <p>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">6. Giới hạn trách nhiệm</h3>
              <p>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">7. Thay đổi điều khoản</h3>
              <p>
              ...
              <h3 className="text-xl font-bold mt-9 mb-3">8. Luật áp dụng</h3>
              <p>
