              ...
              {[
                {
                  ...
                  bio: "Chuyên gia giáo dục với hơn 10 năm kinh nghiệm giảng dạy toán học.",
                },
                {
                  name: "Trần Thị B",
                  role: "Giám đốc sản phẩm",
                  image: "/placeholder.svg?height=200&width=200",
                  bio: "Chuyên gia về thiết kế trải nghiệm người dùng và phát triển sản phẩm giáo dục.",
                },
                {
                  name: "Lê Văn C",
                  role: "Trưởng nhóm kỹ thuật",
                  image: "/placeholder.svg?height=200&width=200",
                  bio: "Kỹ sư phần mềm với chuyên môn về AI và phát triển ứng dụng di động.",
                },
                {
                  name: "Phạm Thị D",
                  role: "Chuyên gia nội dung",
                  image: "/placeholder.svg?height=200&width=200",
                  bio: "Giáo viên toán với kinh nghiệm phát triển giáo trình và nội dung học tập.",
                },
                {
                  name: "Hoàng Văn E",
                  role: "Nhà thiết kế UX/UI",
                  image: "/placeholder.svg?height=200&width=200",
                  bio: "Chuyên gia thiết kế giao diện người dùng với đam mê tạo ra trải nghiệm học tập thú vị.",
                },
                {
                  name: "Vũ Thị F",
                  role: "Quản lý cộng đồng",
                  image: "/placeholder.svg?height=200&width=200",
                  bio: "Chuyên gia xây dựng và phát triển cộng đồng học tập trực tuyến.",
                },
              ].map((member, index) => (
                <div
                  key={index}
